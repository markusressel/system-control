...
> system-control bluetooth pair --remove-existing --connect "00:1D:43:6D:03:1A"
```
...
it also has its downsides, the main one being that it is the least flexible solution since it is a compiled
